...
exports.postCustomer = function (callback) {
  ...
  var sqlStatement = `DECLARE @CustomerID AS int, @Counted AS int, @FlatTypes AS varchar(50) 
  SET NOCOUNT ON 
  ...
  VALUES (
    ...
    SELECT @Counted = ${serviceParameters.Counted}

    WHILE @Counted > 0
    BEGIN
      SELECT TOP (@Counted) @FlatTypes = value FROM STRING_SPLIT('${serviceParameters.FlatTypeID}', ',')
